...
typedef struct {
	u_int users_vector_len;
	user *users_vector_val;
} users_vector;
...
extern  enum clnt_stat get_connected_users_1(users_vector *, CLIENT *);
extern  bool_t get_connected_users_1_svc(users_vector *, struct svc_req *);
#define add_file 8
...
#define get_files 10
extern  enum clnt_stat get_files_1(char *, files_vector *, CLIENT *);
extern  bool_t get_files_1_svc(char *, files_vector *, struct svc_req *);
